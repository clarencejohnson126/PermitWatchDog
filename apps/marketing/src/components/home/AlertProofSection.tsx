import InteractiveBauantrag from '../InteractiveBauantrag';
  ...
  return (
    <section className="bg-zinc-900 py-32 border-t border-zinc-800">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
        ...
        {/* Interactive Permit Inspector */}
        <div className="w-full mb-32">
          <h2 className="text-4xl md:text-5xl font-sans tracking-widest text-white mb-6 text-center uppercase">
            DIE <span className="text-blue">ANALYSE.</span>
          </h2>
          <p className="font-body text-zinc-400 max-w-2xl mx-auto text-center mb-16 text-lg">
            PermitWatchDog liest Bauanträge wie ein Jurist. Klicken Sie auf die markierten 
            Bereiche, um zu sehen, wie unsere Engine Bestandsschutz und Auflagen interpretiert.
          </p>
        ...
        <div className="w-full">
          <h2 className="text-4xl md:text-5xl font-sans tracking-widest text-white mb-16 text-center uppercase">
            DAS <span className="text-blue">RESULTAT.</span>
          </h2>
          
          <div className="w-full max-w-4xl mx-auto bg-white rounded-xl overflow-hidden shadow-2xl border border-zinc-200">
            {/* Outlook Header Fake */}
