    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-zinc-900">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/upload" className="bg-blue hover:bg-blue-light text-white text-sm font-bold font-sans tracking-widest px-6 py-2.5 rounded transition-all shadow-[0_0_15px_rgba(22,84,255,0.3)] hover:shadow-[0_0_25px_rgba(58,123,255,0.5)]">
            BESCHEID HOCHLADEN
          </Link>
        </div>
      </div>
