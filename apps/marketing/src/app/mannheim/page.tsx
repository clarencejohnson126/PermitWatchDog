        ...
        <div className="border border-blue bg-blue/5 rounded-xl p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 font-body text-zinc-300 leading-relaxed">
                <p>
            ...
            <div className="relative aspect-square w-full border border-blue-dark rounded-xl overflow-hidden">
              <Image
                src="/images/bauantrag.png"
                alt="Bauantrag für das Projekt Q5,18 in Mannheim"
                fill
                className="object-cover"
              />
            </div>
        ...
        <div className="max-w-3xl">
          ...
          <div className="space-y-6 font-body text-zinc-400 text-lg leading-relaxed">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center mt-4 px-6 py-3 font-serif tracking-wide rounded bg-blue hover:bg-blue-light text-white shadow-[0_0_15px_rgba(22,84,255,0.3)] hover:shadow-[0_0_25px_rgba(58,123,255,0.5)] transition-all"
            >
